...
const Dashboard = () => {
  ...
  const colors = ["#2563EB", "#7C3AED", "#DB2777", "#D97706"];
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          <button onClick={()=> setShowCreatedResume(true)} className="w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer">
        ...
        <div className="grid grid-cols-2 sm:flex flex-wrap gap-4">
          ...
          {showCreatedResume &&(
            <form onSubmit={createResume} onClick={()=> setShowCreatedResume(false)} className="fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center">
 ...
 max-w-sm p-6">
                ...
                <XIcon onClick={()=>{setShowCreatedResume(false); setTitle("")}} className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 cursor-pointer transition-colors"/>
          ...
          {showUploadResume && (
            <form onSubmit={uploadResume} onClick={()=> setShowUploadResume(false)} className="fixed inset-0 bg-block/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center">
              <div onClick={e=>e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg
 max-w-sm p-6">
